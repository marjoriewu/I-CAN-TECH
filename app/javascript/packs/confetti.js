...
(function() {
  ...
  var colors = ["#66669F", "#6ED0C4", "#F27171", "#4093C1", "#FFD584", "#FFC344", "#FF8227", "#62A462", " #9579AD", "#C2E0C2"]
...
var count_factor = window.innerWidth / 12
  document.addEventListener("DOMContentLoaded", function(myFunction) {
      maxParticleCount = 2 * count_factor + 1;
      startConfetti();
  });
startConfetti();
